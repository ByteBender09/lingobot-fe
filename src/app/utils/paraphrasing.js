    ...
    const response = await axios.post(
      process.env.NEXT_PUBLIC_OPENAI_ENDPOINT,
      {
        ...
        messages: [
          {
            role: "user",
            content: `I input sentence 'The best available source for independent, widely reported, on-the-ground journalism is The New York Times.', expect output: [{"text":"The best available source","alts":["The best source","The most efficient source","The most efficient source","The greatest source","The finest example","The premier source ","The best available"]},{"text":"for","alts":["of","is","that","in","or","about","to","concerning","within"]},{"text":"independent","alts":["autonomous","distinct","separate","autonomous","unrelated","solitary","detached"]},{"text":"widely reported","alts":["widely covered","widely circulated","widely published","extensively reported","extensively covered"]},{"text":"journalism","alts":["reporting","news","media","writing","information","research","reports"]},{"text":"is","alts":["was","remain","are","has","as","has become","seems"]},{"text":"The New York Times","alts":["The Times of New York","The NY Times","The Daily Beast","The Guardian","The Times of London."]}], RETURN SIMILAR OUTPUT WITH SENTENCE : '${sentence}' and please no replace total sentence, just replace word or phrase.`,
          },
        ],
      },
      {
